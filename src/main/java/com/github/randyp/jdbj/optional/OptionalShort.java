...
import com.github.randyp.jdbj.consumer.ShortConsumer;
import com.github.randyp.jdbj.supplier.ShortSupplier;
 ...
 * {@code getAsShort()} will return the value.
 *
 * <p>Additional methods that depend on the presence or absence of a contained
 * value are provided, such as {@link #orElse(short) orElse()}
 * (return a default value if value not present) and
 * {@link #ifPresent(ShortConsumer) ifPresent()} (execute a block
 * of code if the value is present).
 *
 * <p>This is a <a href="../lang/doc-files/ValueBased.html">value-based</a>
 * class; use of identity-sensitive operations (including reference equality
 * ({@code ==}), identity hash code, or synchronization) on instances of
 * {@code OptionalShort} may have unpredictable results and should be avoided.
 *
 * @since 1.8
 */
public final class OptionalShort {
     ...
     *
     * @implNote generally only one empty instance, {@link OptionalShort#EMPTY},
     * should exist per VM.
     */
     ...
     *
     * @param other a {@code ShortSupplier} whose result is returned if no value
     * is present
     ...
     * <li>the present values are "equal to" each other via {@code Short.compare() == 0}.
     * </ul>
     *
    ...
    public boolean equals(Object obj) {
        ...
        return (isPresent && other.isPresent)
                ? Short.compare(value, other.value) == 0
