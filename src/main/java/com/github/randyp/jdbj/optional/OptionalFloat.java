...
import com.github.randyp.jdbj.consumer.FloatConsumer;
import com.github.randyp.jdbj.supplier.FloatSupplier;
 ...
 * {@link #ifPresent(FloatConsumer) ifPresent()} (execute a block
 * of code if the value is present).
 *
 * <p>This is a <a href="../lang/doc-files/ValueBased.html">value-based</a>
 * class; use of identity-sensitive operations (including reference equality
 * ({@code ==}), identity hash code, or synchronization) on instances of
 * {@code OptionalFloat} may have unpredictable results and should be avoided.
 *
 * @since 1.8
 */
public final class OptionalFloat {
     ...
     *
     * @param other a {@code FloatSupplier} whose result is returned if no value
     * is present
     ...
     * <li>the present values are "equal to" each other via {@code Float.compare() == 0}.
     * </ul>
     *
