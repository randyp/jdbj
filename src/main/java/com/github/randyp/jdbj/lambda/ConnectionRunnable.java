 ...
 * <p>
 * When being used as part of a {@link com.github.randyp.jdbj.JDBJ#transaction(ConnectionRunnable)} it is additionally expected not to tamper with {@link Connection#setAutoCommit(boolean)}, {@link Connection#commit()}, {@link Connection#rollback()}, and sometimes {@link Connection#setTransactionIsolation(int)}.
 * <p>
 * Example:
 * <pre>
 * {@code
 ...
 * @see com.github.randyp.jdbj.JDBJ#transaction(ConnectionRunnable)
 */
