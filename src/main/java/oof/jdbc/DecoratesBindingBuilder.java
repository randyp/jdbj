...
public abstract class DecoratesBindingBuilder<E extends DecoratesBindingBuilder<E>> {
    ...
    public E bindList(String name, List<Binding> bindings) {
        return prototype(bindingsBuilder.bindList(name, bindings));
    }

    public E bindList(String name, Binding... bindings) {
        return bindList(name, Arrays.asList(bindings));
    }
