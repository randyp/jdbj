...
import io.codemonastery.jdbj.db.postgres_9_4.PGRule;
...
public class SmartResultSetTest {
    ...
    public static class GetBigDecimal {
        ...
        public void index() throws Exception {
            ...
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getBigDecimal(1));
            assertResults(binding, assertions, db);
        }
        ...
        public void label() throws Exception {
            final BigDecimal expected = new BigDecimal("1.2");
            final Binding binding = pc -> pc.setBigDecimal(expected);
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getBigDecimal("bound"));
            assertResults(binding, assertions, db);
        }
    }
    ...
    public static class GetBoolean {
        ...
        public void index() throws Exception {
            ...
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getBoolean(1));
            assertResults(binding, assertions, db);
        }
        ...
        public void label() throws Exception {
            final Boolean expected = Boolean.TRUE;
            final Binding binding = pc -> pc.setBoolean(expected);
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getBoolean("bound"));
            assertResults(binding, assertions, db);
        }
    ...
    public static class GetBooleanPrimitive {
        ...
        public void index() throws Exception {
            ...
            final Binding binding = pc -> pc.setBoolean(expected);
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getBooleanPrimitive(1));
            assertResults(binding, assertions, db);
        }
        ...
        public void label() throws Exception {
            final Boolean expected = Boolean.TRUE;
            final Binding binding = pc -> pc.setBoolean(expected);
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getBooleanPrimitive("bound"));
            assertResults(binding, assertions, db);
        }
    ...
    public static class GetByte {
        ...
        public void index() throws Exception {
            ...
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getByte(1));
            assertResults(binding, assertions, db);
        }
        ...
        public void label() throws Exception {
            final Byte expected = 12;
            final Binding binding = pc -> pc.setByte(expected);
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getByte("bound"));
            assertResults(binding, assertions, db);
        }
    ...
    public static class GetBytePrimitive {
        ...
        public void index() throws Exception {
            final byte expected = 12;
            final Binding binding = pc -> pc.setByte(expected);
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getBytePrimitive(1));
            assertResults(binding, assertions, db);
        }
        ...
        public void label() throws Exception {
            final byte expected = 12;
            final Binding binding = pc -> pc.setByte(expected);
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getBytePrimitive("bound"));
            assertResults(binding, assertions, db);
        }
    ...
    public static class GetBytes {
        ...
        public void index() throws Exception {
            ...
            final ResultSetAssertions assertions = rs -> Assert.assertArrayEquals(expected, rs.getBytes(1));
            assertResults(binding, assertions, db);
        }
        ...
        public void label() throws Exception {
            final byte[] expected = {12};
            final Binding binding = pc -> pc.setBytes(expected);
            final ResultSetAssertions assertions = rs -> Assert.assertArrayEquals(expected, rs.getBytes("bound"));
            assertResults(binding, assertions, db);
        }
    }
    ...
    public static class GetDate extends HasExpectedTimeSinceEpoch {
        ...
        public void index() throws Exception {
            ...
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getDate(1));
            assertResults(binding, assertions, db);
        }
        ...
        public void indexCalendar() throws Exception {
            ...
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getDate(1, GregorianCalendar.getInstance()));
            assertResults(binding, assertions, db);
        }
        ...
        public void label() throws Exception {
            final Date expected = new Date(expectedTime);
            final Binding binding = pc -> pc.setDate(expected);
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getDate("bound"));
            assertResults(binding, assertions, db);
        }
        ...
        public void labelCalendar() throws Exception {
            final Date expected = new Date(expectedTime);
            final Binding binding = pc -> pc.setDate(expected, GregorianCalendar.getInstance());
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getDate("bound", GregorianCalendar.getInstance()));
            assertResults(binding, assertions, db);
        }
    }
    ...
    public static class GetDouble {
        ...
        public void index() throws Exception {
            ...
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getDouble(1));
            assertResults(binding, assertions, db);
        }
        ...
        public void label() throws Exception {
            final Double expected = 1.2;
            final Binding binding = pc -> pc.setDouble(expected);
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getDouble("bound"));
            assertResults(binding, assertions, db);
        }
    ...
    public static class GetDoublePrimitive {
        ...
        public void index() throws Exception {
            final double expected = 1.2;
            final Binding binding = pc -> pc.setDouble(expected);
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getDoublePrimitive(1), 0.0);
            assertResults(binding, assertions, db);
        }
        ...
        public void label() throws Exception {
            final double expected = 1.2;
            final Binding binding = pc -> pc.setDouble(expected);
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getDoublePrimitive("bound"), 0.0);
            assertResults(binding, assertions, db);
        }
    ...
    public static class GetEnum {
        ...
        public void index() throws Exception {
            ...
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getEnum(1, Fish.class));
            assertResults(binding, assertions, db);
        }
        ...
        public void label() throws Exception {
            final Fish expected = Fish.BLUE;
            final Binding binding = pc -> pc.setString(expected.name());
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getEnum("bound", Fish.class));
            assertResults(binding, assertions, db);
        }
    }
    ...
    public static class GetFloat {
        ...
        public void index() throws Exception {
            ...
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getFloat(1));
            assertResults(binding, assertions, db);
        }
        ...
        public void label() throws Exception {
            final Float expected = 1.2f;
            final Binding binding = pc -> pc.setFloat(expected);
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getFloat("bound"));
            assertResults(binding, assertions, db);
        }
    ...
    public static class GetFloatPrimitive {
        ...
        public void index() throws Exception {
            final float expected = 1.2f;
            final Binding binding = pc -> pc.setFloat(expected);
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getFloatPrimitive(1), 0.0f);
            assertResults(binding, assertions, db);
        }
        ...
        public void label() throws Exception {
            final float expected = 1.2f;
            final Binding binding = pc -> pc.setFloat(expected);
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getFloatPrimitive("bound"), 0.0f);
            assertResults(binding, assertions, db);
        }
    ...
    public static class GetInteger {
        ...
        public void index() throws Exception {
            ...
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getInteger(1));
            assertResults(binding, assertions, db);
        }
        ...
        public void label() throws Exception {
            final Integer expected = 12;
            final Binding binding = pc -> pc.setInt(expected);
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getInteger("bound"));
            assertResults(binding, assertions, db);
        }
    ...
    public static class GetIntegerPrimitive {
        ...
        public void index() throws Exception {
            ...
            final Binding binding = pc -> pc.setInt(expected);
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getIntegerPrimitive(1));
            assertResults(binding, assertions, db);
        }
        ...
        public void label() throws Exception {
            final int expected = 12;
            final Binding binding = pc -> pc.setInt(expected);
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getIntegerPrimitive("bound"));
            assertResults(binding, assertions, db);
        }
    ...
    public static class GetLong {
        ...
        public void index() throws Exception {
            ...
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getLong(1));
            assertResults(binding, assertions, db);
        }
        ...
        public void label() throws Exception {
            final Long expected = 12L;
            final Binding binding = pc -> pc.setLong(expected);
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getLong("bound"));
            assertResults(binding, assertions, db);
        }
    ...
    public static class GetLongPrimitive {
        ...
        public void index() throws Exception {
            ...
            final Binding binding = pc -> pc.setLong(expected);
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getLongPrimitive(1));
            assertResults(binding, assertions, db);
        }
        ...
        public void label() throws Exception {
            final long expected = 12;
            final Binding binding = pc -> pc.setLong(expected);
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getLongPrimitive("bound"));
            assertResults(binding, assertions, db);
        }
    ...
    public static class GetNString {
        ...
        public void index() throws Exception {
            ...
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getNString(1));
            assertResults(binding, assertions, db);
        }
        ...
        public void label() throws Exception {
            final String expected = "abcde";
            final Binding binding = pc -> pc.setNString(expected);
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getNString("bound"));
            assertResults(binding, assertions, db);
        }
    }
    ...
    public static class GetObject {
        ...
        public void index() throws Exception {
            ...
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getObject(1));
            assertResults(binding, assertions, db);
        }
        ...
        public void label() throws Exception {
            final String expected = "abcde";
            final Binding binding = pc -> pc.setObject(expected);
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getObject("bound"));
            assertResults(binding, assertions, db);
        }
    }
    ...
    public static class GetObjectByMap {
        ...
        public void index() throws Exception {
            final String expected = "abcde";
            final Binding binding = pc -> pc.setObject(expected);
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getObject(1, typeMap));
            assertResults(binding, assertions, db);
        }
        ...
        public void label() throws Exception {
            final String expected = "abcde";
            final Binding binding = pc -> pc.setObject(expected);
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getObject("bound", typeMap));
            assertResults(binding, assertions, db);
        }
    }
    ...
    public static class GetObjectByClass {
        ...
        public void index() throws Exception {
            final String expected = "abcde";
            final Binding binding = pc -> pc.setObject(expected);
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getObject(1, String.class));
            assertResults(binding, assertions, db);
        }
        ...
        public void label() throws Exception {
            final String expected = "abcde";
            final Binding binding = pc -> pc.setObject(expected);
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getObject("bound", String.class));
            assertResults(binding, assertions, db);
        }
    }
    ...
    public static class GetShort {
        ...
        public void index() throws Exception {
            ...
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getShort(1));
            assertResults(binding, assertions, db);
        }
        ...
        public void label() throws Exception {
            final Short expected = 12;
            final Binding binding = pc -> pc.setShort(expected);
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getShort("bound"));
            assertResults(binding, assertions, db);
        }
    ...
    public static class GetShortPrimitive {
        ...
        public void index() throws Exception {
            final short expected = 12;
            final Binding binding = pc -> pc.setShort(expected);
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getShortPrimitive(1));
            assertResults(binding, assertions, db);
        }
        ...
        public void label() throws Exception {
            final short expected = 12;
            final Binding binding = pc -> pc.setShort(expected);
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getShortPrimitive("bound"));
            assertResults(binding, assertions, db);
        }
    ...
    public static class GetString {
        ...
        public void index() throws Exception {
            ...
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getString(1));
            assertResults(binding, assertions, db);
        }
        ...
        public void label() throws Exception {
            final String expected = "abcde";
            final Binding binding = pc -> pc.setString(expected);
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getString("bound"));
            assertResults(binding, assertions, db);
        }
    }
    ...
    public static class GetTime extends HasExpectedTimeOfDay {
        ...
        public void index() throws Exception {
            ...
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getTime(1));
            assertResults(binding, assertions, db);
        }
        ...
        public void indexCalendar() throws Exception {
            ...
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getTime(1, GregorianCalendar.getInstance()));
            assertResults(binding, assertions, db);
        }
        ...
        public void label() throws Exception {
            final Time expected = new Time(expectedMillis);
            final Binding binding = pc -> pc.setTime(expected);
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getTime("bound"));
            assertResults(binding, assertions, db);
        }
        ...
        public void labelCalendar() throws Exception {
            final Time expected = new Time(expectedMillis);
            final Binding binding = pc -> pc.setTime(expected, GregorianCalendar.getInstance());
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getTime("bound", GregorianCalendar.getInstance()));
            assertResults(binding, assertions, db);
        }
    }
    ...
    public static class GetTimestamp extends HasExpectedTimeSinceEpoch {
        ...
        public void index() throws Exception {
            ...
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getTimestamp(1));
            assertResults(binding, assertions, db);
        }
        ...
        public void indexCalendar() throws Exception {
            ...
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getTimestamp(1, GregorianCalendar.getInstance()));
            assertResults(binding, assertions, db);
        }
        ...
        public void label() throws Exception {
            final Timestamp expected = new Timestamp(expectedTime);
            final Binding binding = pc -> pc.setTimestamp(expected);
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getTimestamp("bound"));
            assertResults(binding, assertions, db);
        }
        ...
        public void labelCalendar() throws Exception {
            final Timestamp expected = new Timestamp(expectedTime);
            final Binding binding = pc -> pc.setTimestamp(expected, GregorianCalendar.getInstance());
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getTimestamp("bound", GregorianCalendar.getInstance()));
            assertResults(binding, assertions, db);
        }
    }
    ...
    public static class GetURL {
        ...
        public void index() throws Exception {
            ...
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getURL(1));
            assertResults(binding, assertions, db);
        }
        ...
        public void label() throws Exception {
            ...
            final Binding binding = pc -> pc.setString(expected.toString());
            final ResultSetAssertions assertions = rs -> Assert.assertEquals(expected, rs.getURL("bound"));
            assertResults(binding, assertions, db);
        }
    }
