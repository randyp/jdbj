...
public class JDBJTest {
    ...
    public static class Update {
        ...
        public void insertQueryNotEnoughBindings() throws Exception {
            final ExecuteUpdate executeUpdate = JDBJ.insertQuery(Student.insert_id);
            try (Connection connection = db.getConnection()) {
    ...
    public static class BatchedUpdate {
        ...
        public void insertBatch() throws Exception {
            ...
            BatchedExecuteUpdate insertQuery = JDBJ.insertQuery(Student.insert_id).asBatch();
        ...
        public void batchAlreadyEnded() throws Exception {
            ...
            final BatchedExecuteUpdate.Batch batch = JDBJ.insertQuery(Student.insert_id).asBatch()
                    .startBatch()
                    .bindLong(":id", student.id)
                    .bindString(":first_name", student.firstName)
                    .bindString(":last_name", student.lastName)
